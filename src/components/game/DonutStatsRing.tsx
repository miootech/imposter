      ...
      {layout.map((seg, idx) => {
        ...
        return (
          ...
          >
            ...
            />
            {/* Icon centered — supports both emoji and uploaded images */}
            <span
            ...
            >
              {typeof seg.icon === 'string' && seg.icon.startsWith('data:image') ? (
                <img
                  src={seg.icon}
                  alt="Icon"
                  style={{
                    width: `${Math.max(14, strokeWidth * 0.6)}px`,
                    height: `${Math.max(14, strokeWidth * 0.6)}px`,
                    objectFit: 'cover',
                    borderRadius: '50%',
                  }}
                />
