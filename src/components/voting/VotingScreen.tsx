      ...
      <div className="mx-auto w-full max-w-md px-5 pt-12 pb-32">
        ...
        <div className="mb-6 flex justify-center">
          <motion.div
            ...
            style={{ backgroundColor: currentVoter.color }} aria-label={currentVoter.displayName}
          ...
          {livingPlayers.map((p, idx) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  'group relative flex flex-col items-center gap-2 rounded-3xl p-4 text-center transition-all',
                  isSelected
              ...
              >
                ...
                >
                  {p.icon ? <IconRenderer icon={p.icon} size={56} /> : p.displayName.slice(0, 2).toUpperCase()}
                </motion.div>
