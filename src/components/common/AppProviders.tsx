...
import { AppLifecycleHandler } from '@/components/common/AppLifecycleHandler'
...
export function ThemeBridge() {
  ...
  const bgMusicEnabled = usePreferencesStore(s => s.bgMusicEnabled)
  ...
  // Start idle music when bg music is enabled
  useEffect(() => {
    if (bgMusicEnabled) {
      playMusicTrack('idle')
    } else {
